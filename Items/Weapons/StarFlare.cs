...
namespace EverquartzAdventure.Items.Weapons
{
    public class StarFlare : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(2, 0, 0, 0); // The amount of money that the item is can be bought for.
            ...
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<StarbornPrincessItem>();
        }
        public override void PostUpdate()
        {
            Lighting.AddLight(Item.Center, Color.WhiteSmoke.ToVector3() * 1 * Main.essScale);
        }
    }
    ...
    public class DeimosYoYoProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.TintableDustLighted, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 0, Color.LavenderBlush, 1f);
            }
    ...
    public class DeimosYoyoHeadProjectile: ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust flareProjDust;
                flareProjDust = Dust.NewDustDirect(Projectile.Center, Projectile.width, Projectile.height, DustID.TintableDustLighted, Projectile.velocity.X, Projectile.velocity.Y, 0, default(Color), 1.2f);
                flareProjDust.noGravity = true;
                flareProjDust.fadeIn = 1.5f;
                Dust flareProjDust2 = flareProjDust;
                flareProjDust2.velocity *= 0.5f;
