...
namespace EverquartzAdventure.Items.Weapons
{
    ...
    public class SundialNimbus : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            //Item.DefaultToStaff(ModContent.ProjectileType<EverquartzProjectile>(), 8, 20, 34);
            Item.noMelee = true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<CelestialGeode>(1);
            recipe.AddIngredient(ItemID.Pearlwood, 100);
            if (ModCompatibility.calamityEnabled)
            {
                recipe.AddIngredient(CalamityWeakRef.ItemType.AuricBar, 5);
