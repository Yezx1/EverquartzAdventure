...
namespace EverquartzAdventure
{
    ...
    internal static partial class CalamityWeakRef
    {
        ...
        internal static class ItemType
        {
            ...
            internal static int Bloodstone => ModContent.ItemType<Bloodstone>();
            ...
            internal static int SoulofCryogen => ModContent.ItemType<SoulofCryogen>();
            internal static int CryonicBar => ModContent.ItemType<CryonicBar>();
            ...
            internal static int ExodiumCluster => ModContent.ItemType<ExodiumCluster>();
            internal static int SupremeHeal => ModContent.ItemType<SupremeHealingPotion>();
            internal static int OmegaHeal => ModContent.ItemType<OmegaHealingPotion>();
            internal static int ShadowspecBar => ModContent.ItemType<ShadowspecBar>();
            internal static int CosmiliteBar => ModContent.ItemType<CosmiliteBar>();
            internal static int GalacticaSingularity => ModContent.ItemType<GalacticaSingularity>();
            internal static int SupremeMana => ModContent.ItemType<SupremeManaPotion>();
            internal static int guidelightOfOblivion => ModContent.ItemType<GuidelightofOblivion>();
            internal static int DeliciousMeat => ModContent.ItemType<DeliciousMeat>();
            internal static int BotanicPlanter => ModContent.ItemType<BotanicPlanter>();
            internal static int AuricBar => ModContent.ItemType<AuricBar>();
            internal static int BlasphemousDonut => ModContent.ItemType<BlasphemousDonut>();
            internal static int ElysianWings => ModContent.ItemType<ElysianWings>();
            internal static int ElysianTracers => ModContent.ItemType<TracersElysian>();
            internal static int AstralInjection => ModContent.ItemType<AstralInjection>();
            internal static int Fabsoup => ModContent.ItemType<Fabsoup>();
            internal static int Rock => ModContent.ItemType<Rock>();
        }
    }
