    ...
    public static class TransmogrificationManager
    {
        ...
        internal static void LoadAllTrans()
        {
            Transmogrifications = new List<TransmogrificationRecipe>
            {
                ...
                new TransmogrificationRecipe(ItemID.PortalGun, ModContent.ItemType<DeimosFumo>(), 1, ModContent.ItemType<DeimosFumoCannon>(), 1, 30)
            ...
            };  //Transmogrifications.Add(new TransmogrificationRecipe([[MAIN ITEM]], [[SECONDARY ITEM]], [[SECONDARY ITEM AMOUNT]], [[OUTPUT ITEM]], [[OUTPUT ITEM AMOUNT]], [[DURATION IN SECONDS]]));
            if (ModCompatibility.calamityEnabled)
            {
                ...
                Transmogrifications.Add(new TransmogrificationRecipe(ItemType.SoulofCryogen, ItemType.CryonicBar, 25, ItemType.DeliciousMeat, 1, 300)); //
                Transmogrifications.Add(new TransmogrificationRecipe(ItemType.Rock, ItemType.ShadowspecBar, 5, ModContent.ItemType<Mineral>(), 1, 30)); //
